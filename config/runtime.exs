...
#
#     PHX_SERVER=true bin/drink_water start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :drink_water, DrinkWaterWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :drink_water, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :drink_water, DrinkWater.Mailer,
