...
config :drink_water, DrinkWaterWeb.Endpoint,
  ...
  watchers: [
    ...
    tailwind: {Tailwind, :install_and_run, [:drink_water, ~w(--watch)]}
  ]
...
config :drink_water, DrinkWaterWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/drink_water_web/router\.ex$"E,
      ~r"lib/drink_water_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :drink_water, dev_routes: true
...
# Disable Sentry in dev (enable temporarily with SENTRY_DSN env var for testing)
